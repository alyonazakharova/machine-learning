...
# gamma = 0.5
# полиномиальное степеней 1-5, сигмоидальная функция, гауссово
poly_svc_1 = svm.SVC(kernel='poly', gamma=10).fit(x_train, y_train)
...
models = [poly_svc_1,
          # poly_svc_2, poly_svc_3,
          # poly_svc_4, poly_svc_5, sigmoid_svc,
          # rbf_svc]
          ]
